...
import { EmergencyLight8, EmergencyLight9 } from '../../data/Electrical/emergencyLight9';

const EmergencyLightForm = () => {
    const navigate = useNavigate();

    const plantDataSet = {
        "TYB-8": EmergencyLight8,
        "TYB-9": EmergencyLight9
    }
    ...
    const handleChange = (e) => {
        ...
        if (name === 'unit') {
            ...
            const updatedFormData = selectedData.reduce((acc, data) => {
                acc[data.label] = Array(data.question.length).fill({ value: "", backupTime: "", remark: "" });
                return acc;
            }, {});
            setFormData(prevState => ({
                ...prevState,
                                            ...
                                            <tr key={qIndex} className="border-b-4 bg-white">
                                                ...
                                                <td className="whitespace-nowrap border-r-4 px-3 py-4 dark:border-neutral-500 text-gray-900">
                                                    <input
                                                        ...
                                                        value={formData[data.label][qIndex].backupTime || ""}
                                                        onChange={(e) => handleSelectChange(e, data.label, qIndex, 'backupTime')}
...
export default EmergencyLightForm;
